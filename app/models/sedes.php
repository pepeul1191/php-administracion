...
class Sedes extends Database
{
    ...
    {
      return ORM::for_table('sedes')->select('id')->select('nombre')->select('distrito_id')->where('empresa_id', $empresa_id)->find_array();
    }

    public function crear($nombre, $distrito_id, $empresa_id)
    {
    ...
    public function editar($id, $nombre, $distrito_id)
    {
